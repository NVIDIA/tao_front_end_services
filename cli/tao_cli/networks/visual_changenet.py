...
"""Visual ChangeNet tao-client modules"""
import click
import json
import ast
...
@click.group()
def visual_changenet():
    """Create Visual ChangeNet model click group"""
    pass


@visual_changenet.command()
...
@click.option('--dataset_pull', type=str, help='The dataset pull URL.', required=False, default=None)
